...
class _HosteldetailsState extends State<Hosteldetails> {
  // Dropdown variables
  String? bathrooms;
  String? categoryofpeople;
  String? furnishing;
  String? visitorsAllowed;
  String? diningfacility;
  String? parking;
  String? electricity;
  String? sharing;
  ...
  Future<bool> _submitForm(List<String> images) async {
    try {
      ...
      await ApiFunctions().sendHostelDetails(
        parking: parking ?? '',
        furnished: furnishing ?? '',
        electricity: electricity ?? '',
        visitors: visitorsAllowed ?? '',
        bathrom: bathrooms ?? '',
        dining: diningfacility ?? '',
        sharing: sharing ?? '',
        gender: categoryofpeople ?? '',
        hostelName: _ownerNameController.text,
        rent: _monthlyrentController.text,
        location: _locationController.text,
        maintainance: _monthlyMaintenanceController.text,
        timing: _timingsController.text,
        totalfloor: _totalFloorsController.text,
        deposit: _depositController.text,
        feature: feature,
        categoryType: 'Flat',
        HostelDes: _descriptionController.text.toString(),
        images: images,
            ...
            child: Column(
              ...
              children: [
                ...
                buildDropdownField(
                    ...
                    categoryofpeople,
                    (value) => setState(() => categoryofpeople = value)),
                buildDropdownField(" Bathroom", ["sharing", "separate"],
                ...
                buildDropdownField(
                    ...
                    ["Yes", "No"],
                    visitorsAllowed,
                    (value) => setState(() => visitorsAllowed = value)),
                buildDropdownField(
                    "Dining Facility",
                    ["Yes", "No"],
                    diningfacility,
                    (value) => setState(() => diningfacility = value)),
                buildDropdownField(
                    "Parking",
                    [
                      "4 Wheeler",
                ...
                buildDropdownField(
                    ...
                    electricity,
                    (value) => setState(() => electricity = value)),
                buildDropdownField(
                    "sharing",
                    [
                      "single sharing",
