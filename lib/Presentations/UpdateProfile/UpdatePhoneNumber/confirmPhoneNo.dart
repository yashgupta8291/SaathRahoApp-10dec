...
class _UpdateEmailPageState extends State<UpdatePhoneNo> {
  ...
  Future<void> validateOtp() async {
    if (_otpController.text.isEmpty || _otpController.text.length != 5) {
      ...
      await ApiFunctions().verifyPhoneUpdate(context, email,
          _otpController.text.toString(), _phoneController.text.toString());
      prefs.setString('phoneNo', _phoneController.text.toString());
      tokenController.phoneNumber.value = _phoneController.text.toString();
      setState(() {
        checkotp = "";
      });
    }
